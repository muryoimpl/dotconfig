...
vim.keymap.set('n', '<space>lt', function() builtin.lsp_type_definitions()      end, kopts)
vim.keymap.set('n', '<space>gs', function() builtin.git_stash()                 end, kopts)
vim.keymap.set('n', '<space>gbr', function() builtin.git_branches()             end, kopts)
...
vim.keymap.set('n', '<space>gt', function() builtin.git_status()                end, kopts)
vim.keymap.set('n', '<space>bl', function() builtin.current_buffer_fuzzy_find() end, kopts)
vim.keymap.set('n', '<space>hi', function() builtin.command_history()           end, kopts)
...
vim.keymap.set('n', '<space>hp', function() builtin.help_tags()                 end, kopts)
